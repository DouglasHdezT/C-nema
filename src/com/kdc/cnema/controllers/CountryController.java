...
public class CountryController {
	...
	@Autowired
	CountryAuditService auditService;
	...
	public ResponseEntity<List<Country>> getAllCountries(){
		...
		return new ResponseEntity<List<Country>>(countries, code);
	}
	
	@RequestMapping("/countries/all/audits")
	public ResponseEntity<List<CountryAudit>> getAllAudits(@RequestHeader("Authorization") String authHeader){
		List<CountryAudit> audits =  new ArrayList<>();	
		HttpStatus code = HttpStatus.BAD_REQUEST;
		...
		return new ResponseEntity<List<CountryAudit>>(audits, code);
	}
